...
<div class="block-bottom">
    <div class="container">
        <div class="catalog">
            <div class="catalog-item catalog-category-details">
                <div class="catalog-category-details__item catalog-category-details__breadcrumbs">
					<?php include($_SERVER["DOCUMENT_ROOT"] . "/build/" . "components/breadcrumbs.php"); ?>
                </div>

                <div class="catalog-category-details__item catalog-category-details__header">
                    <div class="catalog-category-details__title">Застежки-молнии</div>
                    <div class="catalog-category-details__subtitle">Предназначена для швейных и галантерейных изделий из материалов с поверхностной плотностью от 200 г/м2 до 400 г/м2 (кожаные, замшевые и меховые изделия; джинсовая и легкая брезентовая ткань).</div>
                </div>

                <div class="catalog-category-details__item catalog-category-details__view">
                    <img
                            loading="lazy"
                    ...
                    >
                    <div class="catalog-category-details__item catalog-category-details__download">
                        <a class="btn-reset btn btn-primary" href="javascript:;">
                            <span class="btn__text">Скачать PDF-каталог</span>
                        </a>
                    </div>
                </div>

                <div class="catalog-category-details__item catalog-category-details__descr">
                    <div class="catalog-category-details__descr-item">
                        <svg class="icon">
                            <use href="img/advantage-cup.svg#advantage-cup"></use>
                        </svg>
                        <span>Предназначена для швейных и галантерейных изделий</span>
                    </div>
                    <div class="catalog-category-details__descr-item">
                        <svg class="icon">
                    ...
                    <div class="catalog-category-details__descr-item">
                        ...
                        <span>Самый большой цех покраски</span>
                    </div>
                </div>
            </div>
